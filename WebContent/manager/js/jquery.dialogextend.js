...
(function() {
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    minimize: function() {
      ...
      newHeight = 30;//$(this.element[0]).dialog("widget").find(".ui-dialog-titlebar").height()-15;
      newWidth = 200;
      ...
      fixedContainer.css({
        ...
        "left": 0,
        "right": 0,
        //"background": "#FFF url(images/taskBar/taskbuttons-panel-bg.gif) repeat-x",
        //"z-index": 99
      });
      overlay = $('<div/>').css({
      ...
      $(this.element[0]).dialog("option", {
        ...
        return titleText.css({
          'overflow': 'hidden',
          'width': titlebar.width() - buttonPane.width() 
        });
