...
<div class="content1">
	<div class="dropshadow dropshadow5">
		<div class="ui-corner-all innerbox innerbox5">			
			<div>
				<div
					style="background-image: url('<%=request.getContextPath()%>/img/content_title_left.png'); background-repeat: no-repeat; width: 134px; height: 34px; float: left; margin-left: -4px;">校园动态</div>
				<div
			...
			<div id="content_r2c2dongtai_description">
			新闻动态
			</div>
			</div>
	</div>
