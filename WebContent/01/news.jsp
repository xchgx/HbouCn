...
<title>Sailing Theme - News Page</title>
<meta name="keywords" content="sailing, news, web design, free templates, website templates, CSS, HTML" />
<meta name="description" content="Sailing Theme | News Page | free website template" />
    ...
    <div id="templatemo_slider">
		...
		<div id="featured" >
			<ul class="ui-tabs-nav">
				...
				<li class="ui-tabs-nav-item" id="nav-fragment-2"><a href="#fragment-2"><img src="images/content_slider/image2-small.jpg" alt="Image2samll" /><span>Vestibulum ante ipsum primis in faucibus orci luctus et</span></a></li>
    ...
    <div id="templatemo_content">
        ...
        <div class="col_w600">
        	<div class="news_box">
                ...
                <div class="news_meta">May 30th, 2048 | <a href="http://sc.chinaz.com/page/1" target="_parent">Web Templates</a> by <a href="http://sc.chinaz.com" target="_parent">George</a></div>
             ...
             <div class="news_box news_box_last">
				...
				<div class="news_meta">May 15th, 2048 | <a href="http://sc.chinaz.com/page/1" target="_parent">User Interfaces</a> by <a href="http://sc.chinaz.com" target="_parent">Steven</a></div>
        ...
        <div class="col_w300 col_last">
            ...
            <div class="cleaner"></div>
            <div class="btn_more"><a href="services.jsp">Read more</a></div>
        </div>
