...
<body>
	...
	<input type="hidden" value="${department.id?c }"  id="departmentIndexDptId">
		...
		<div class="content_main">
			...
			<%@include file="../section/content_r2c1_sec${section.id?c }.jsp"%>
			</div>
			<div>
				<%@include file="content_r1c2_art${article.id?c }.jsp"%>
				<div id="contentArticleListId"><iframe  src="${basePath}/index/article/${article.id?c}.jsp"  style="width:770px; height:670px; border: 0; margin: 0; padding: 0;"></iframe></div>
			</div>
