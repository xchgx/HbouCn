...
<body>
	...
	<input type="hidden" value="${department.id?c }"  id="departmentIndexDptId">
		...
		<div class="content_main">
			...
			<%@include file="content_r2c1_sec${sectionId?c }.jsp"%>
			</div>
			<div>
				<%@include file="content_r1c2_sec${sectionId?c }.jsp"%>
				<div id="contentArticleListId"><%@include file="sectionArticles${sectionId }_1.jsp"%></div>
			</div>
